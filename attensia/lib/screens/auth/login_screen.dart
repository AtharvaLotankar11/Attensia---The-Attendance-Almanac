...
class _LoginScreenState extends State<LoginScreen> {
  ...
  void _showErrorDialog(String message) {
    ...
    if (message.contains('Email not confirmed')) {
      errorMessage = 'Please verify your email first or contact support.';
    } else if (message.contains('Invalid login credentials')) {
      errorMessage = 'Invalid email or password';
    } else if (message.contains('Email link is invalid or has expired')) {
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              Text('Login Failed', style: AppTheme.dialogTitle),
              ...
              Text(
                'Debug: ${message.length > 100 ? message.substring(0, 100) : message}',
                style: AppTheme.labelText.copyWith(fontSize: 10, color: Colors.grey),
                textAlign: TextAlign.center,
              ),
            ...
            child: Column(
              ...
              children: [
                ...
                Container(
                  ...
                  child: Column(
                    children: [
                      Icon(Icons.school, size: 64, color: AppTheme.textColor),
                      const SizedBox(height: 12),
                      Text('Attensia', style: AppTheme.appBarTitle),
